...
class WeatherBackendApplicationTests {
	...
	private String userName = "amitavmfssssdsd";
	private String userPass = "amitavmf";
	private int favId = 1275339;
	@Test
	@Order(1)
	public void testCreateUser(){
		User user = new User();
		user.setPhone("87342323");
	...
	public void takeCityWeather(){
		var output = apiDataService.consumeCityApi("https://api.openweathermap.org/data/2.5/weather?q=mumbai&appid=f896b0fcb80ccea35259af44e58dd80a");
	...
	public void favoriteAdd(){
		...
		var saveFav = favouriteRepository.save(wish);
